...
public interface KarmaHistoryRepository extends JpaRepository<KarmaHistory, Long> {
    ...
    Integer getDailyEarnedPoints(@Param("userId") Long userId, @Param("since") LocalDateTime since);
    ...
    Integer getPointsByPost(@Param("userId") Long userId, @Param("reason") KarmaReason reason, @Param("postKey") String postKey);
